# viator-gyg-item-card-numberer-
## Installation

Make sure you have the [Tampermonkey](https://www.tampermonkey.net/) extension installed in your browser, then click the links below to install the userscripts automatically:

| Script | Target Site | Install Link |
| :--- | :--- | :--- |
...
[![Install GYG Data scraper](https://img.shields.io/badge/Install-GYG_Extractor Script-008080?style=for-the-badge&logo=tampermonkey)](https://github.com/AmajesticBob/viator-gyg-item-card-numberer-/raw/refs/heads/main/gyg_extract.user.js))
...
> [!CAUTION]
> **Status: Abandoned to the Machines 🤖**
>
> This repository is strictly unmaintained. If a site update breaks a selector or something explodes:
> 1. Copy the code.
> 2. Paste it into your favorite AI.
> 3. Tell it what broke.
> 4. Pray it doesn't hallucinate an entire new framework.
>
> Issues and pull requests are monitored exclusively by dust mites. You've got this!
